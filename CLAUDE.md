...
- [docs/roadmap/08-modmail-custom-instances.md](docs/roadmap/08-modmail-custom-instances.md) — #216, branded single-guild ModMail deployments + DM front door (planned, not started).

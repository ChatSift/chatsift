...
## Status: P1/P2/P3 shipped 2026-07-29 (#278/#279 merged; P3 implemented + manually verified, not yet committed); P4 (DM mode) next

**Picking this up in a new session? Read this before touching P4:**

- P1 and P2 are committed on `main` (#278, #279). P3 (below) is implemented and manually verified this session but left staged/uncommitted per this repo's CLAUDE.md — check `git status` before assuming what's merged.

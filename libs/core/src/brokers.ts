...
import type { ApiPostFiltersFilesResult, ApiPostFiltersUrlsBody, HttpCase } from './api';
...
export type UrlsRunnerResult = OkRunnerResult<Runners.urls, ApiPostFiltersUrlsBody>;

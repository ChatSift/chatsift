// https://github.com/sapphiredev/utilities/pull/515
...
export class CommandInteractionOptionResolver {
	...
	public getMentionable(name: string, required?: true): APIInteractionDataResolvedGuildMember | APIRole | APIUser;
	...
	public getTargetMember(required = false): APIInteractionDataResolvedGuildMember | null {
		...
		const member =
			(this.resolved as APIUserApplicationCommandInteractionDataResolved).members?.[this.interaction.data.target_id] ??
			null;
		if (!member && required) {

...
export class CoralCommandHandler extends ICommandHandler<CoralInteractionHandler> {
	readonly #credentials = credentialsForCurrentBot();
	...
	public constructor(
		...
		this.#executor = new CoralExecutor(api, this.#credentials.clientId)
	...
	public async deployCommands(): Promise<void> {
		await this.api.applicationCommands.bulkOverwriteGlobalCommands(this.#credentials.clientId, this.#interactions);
	}
	...
	private interactionToActions(interaction: APIInteraction): CoralActions {
		return new CoralActions(this.api, this.#credentials.clientId, interaction);
	}

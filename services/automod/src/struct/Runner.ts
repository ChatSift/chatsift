import type { RunnerResult, FilterIgnoresResolvable } from '@automoderator/common';
import type { APIMessage } from 'discord-api-types/v10';

type MaybePromise<T> = Promise<T> | T;

export type Runner<Transform = unknown, Result = Transform, Log extends RunnerResult = RunnerResult> = {

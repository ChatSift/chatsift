...
export const BanwordCommand = {
	name: 'banword',
	description: "Allows you to mange your server's banned words and phrases",
	...
	options: [
		{
			...
			options: [
				...
				{
					name: 'mute-duration',
					description: "Duration for the mute, if you don't want it to be permanent",
					type: ApplicationCommandOptionType.String,
					required: false,
				},
				{
					name: 'kick',
					description: 'Whether or not triggering this entry should cause a kick',
					type: ApplicationCommandOptionType.Boolean,
					required: false,
				},
				{
